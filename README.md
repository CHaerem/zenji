...
| Siste 7 dager | topp 100% · snitt 60% | 28t i sparemodus |

<sub>Oppdatert 2026-07-24 18:49 UTC av `usage-monitor` · kilde: `docs/data/usage-summary.json` · [Self-throttling on quota](#self-throttling-on-quota)</sub>
<!-- STATUS:END -->
